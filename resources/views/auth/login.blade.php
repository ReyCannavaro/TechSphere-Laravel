...
<head>
    ...
    <title>{{ __('Login') }} - Welcome Back</title>
...
<body class="min-h-screen gradient-bg flex items-center justify-center p-4 overflow-hidden">
    ...
    <div class="relative w-full max-w-md z-10">
        ...
        <div class="glass-morphism rounded-3xl p-10 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl">
            ...
            <!-- Login Form -->
            <form method="POST" action="{{ route('login') }}" class="space-y-8" id="login-form">
                @csrf
                ...
                <div class="relative group">
                    ...
                    <div class="relative">
                        ...
                        >
                        <button type="button" class="absolute inset-y-0 right-0 pr-4 flex items-center z-10" onclick="togglePassword()">
                ...
                <div class="flex items-center justify-between py-2">
                    <label for="remember_me" class="flex items-center group cursor-pointer">
                        <input 
                            id="remember_me" 
                            type="checkbox" 
                            class="h-5 w-5 text-indigo-600 border-2 border-gray-300 rounded focus:ring-indigo-500 focus:ring-2 transition-all duration-200" 
                            name="remember"
                            {{ old('remember') ? 'checked' : '' }}
                        >
                        <span class="ml-3 text-sm text-gray-700 font-semibold group-hover:text-indigo-600 transition-colors duration-200">
                            {{ __('Remember me') }}
                        </span>
                    </label>

                    @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-sm font-semibold text-indigo-600 hover:text-indigo-800 transition-all duration-200 hover:underline">
                ...
                >
                    ...
                    <div class="relative flex items-center justify-center">
                        <i class="fas fa-sign-in-alt mr-3 text-lg" id="submit-icon"></i>
                        <span class="text-lg" id="submit-text">{{ __('Log in') }}</span>
                    </div>
                </button>
                ...
                <div class="relative my-8">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 bg-white text-gray-500 font-semibold">{{ __('or sign in with') }}</span>
                    </div>
                </div>
                ...
                <div class="text-center pt-6 border-t border-gray-200">
                    <p class="text-gray-600 font-medium">
                        ...
                        <a href="{{ route('register') }}" class="font-bold text-indigo-600 hover:text-indigo-800 transition-all duration-200 hover:underline transform hover:scale-105 inline-block">
                            {{ __('Register now') }}
                        </a>
                    </p>
                </div>
